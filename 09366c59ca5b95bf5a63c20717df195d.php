...
<body style="background-color: #FFB1B1">
        ...
        <div class="card w-75 p-5 border-0 shadow rounded-4">
            <div class="row">
                <div class="col-6">
                    ...
                    <p class="text-center mt-3 fw-bold">Aira Florist Garut</p>
                    
                    <!-- Form Login -->
                    <form action="<?php echo e(route('login.submit')); ?>" enctype="multipart/form-data" method="POST" class=" form-group">
                        ...
                        <div class="mt-4">
                            <a class="btn btn-primary w-100 border-0" href="<?php echo e(route('home')); ?>" style="background-color: #FFB1B1">Kembali</a>
                        </div>
    ...
    <style>
        .a {
            background-image: url(asset/images/tulippink.jpg);
...
<?php /**PATH C:\xampp1\htdocs\MoonlightBlooms\resources\views/index.blade.php ENDPATH**/ ?>